import imp
exchange_rate_today = imp.load_source('get_ExchangeRate', '/c/Users/uzer/Desktop/pythonstuff/get_ExchangeRate.py')
...
class Ccy:
    ...
    #             }
    currencies = exchange_rate_today.get_currency_rates2()
